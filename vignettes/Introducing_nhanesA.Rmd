...
## Special Cases
Some NHANES measurements require special handling due to excessive
statistical anomalies. There are additional surveys conducted that are
beyond the scope of the continuous survey, but are provided in a similar
...
better use of data that was collected, data from the 2017-2018 survey were included to form a 
