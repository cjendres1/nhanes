...
As a default, the nhanes function will translate coded values. If desired, this default behavior can be turned off by setting translate = FALSE. You may then customize the translation of coded fields using nhanesTranslate.
