...
NHANES data tables and are available on an ftp server only. More information may be found at http://www.cdc.gov/nchs/nhanes/dxx/dxa.htm. By default the DXA data are imported into the R environment, however, because the tables are quite large it may be desirable to download the data to a local file then
import to R as needed.
```{r, eval=FALSE}
#Importing into R
